...
// express-winston integrates directly with Express.js, so that all standard API-related 
// winston logging code is already done.

// cors is a piece of Express.js middleware that allows us to enable cross-origin resource sharing. 
// Without this, our API would only be usable from front ends being served from the exact same 
// subdomain as our back end.
...
//  (after any middleware) processes a route request, calls the above service functions
//   if necessary, and gives a response to the client